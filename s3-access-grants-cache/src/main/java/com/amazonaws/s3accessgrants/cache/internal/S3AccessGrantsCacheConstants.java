...
public class S3AccessGrantsCacheConstants {
    ...
    public static final int MAX_BUCKET_REGION_EXPIRE_CACHE_AFTER_WRITE_SECONDS = 3_600; // 1 hour
    public static final int BUCKET_REGION_EXPIRE_CACHE_AFTER_WRITE_SECONDS= 86_400; // 1 day
}
